...
rr2 = Review.create(title: 'Love', description: 'The Grateful Deads 2 studio album.', rating: 5, record_id: r2.id, user_id: u2.id)
rr3 = Review.create(title: 'Hate', description: 'Waylon Jennings released this with the help of Johnny Cash and Merle Haggard', rating: 3, record_id: r3.id, user_id: u3.id)
